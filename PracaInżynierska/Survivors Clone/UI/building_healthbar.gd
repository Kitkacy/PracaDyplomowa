...
func initialize_full_health():
	...
	# Set full opacity
	modulate.a = 0.8  # Semi-transparent for buildings
...
func update_health(current_health: int, max_health: int):
	...
	print("Building Healthbar update - HP: ", current_health, "/", max_health, " (", health_percentage * 100, "%)")
	...
	# Position and size the fill bar manually
